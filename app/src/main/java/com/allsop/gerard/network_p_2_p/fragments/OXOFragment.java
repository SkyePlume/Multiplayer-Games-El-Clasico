...
import com.allsop.gerard.network_p_2_p.game.Board;
import com.allsop.gerard.network_p_2_p.game.GameState;
import com.allsop.gerard.network_p_2_p.game.PlayerMove;
import com.allsop.gerard.network_p_2_p.game.PlayerState;
import com.allsop.gerard.network_p_2_p.game.PlayerType;
import com.google.gson.Gson;
/**
 * Edited by Skye  on 22/03/2017.
 */
public class OXOFragment extends Fragment {
    ...
    private static int[] playerImages = {R.drawable.spurs,R.drawable.arsenal};
    private static int[] boardImages = {R.drawable.topleft,R.drawable.topcentre, R.drawable.topright, R.drawable.middleleft, R.drawable.middlecentre, R.drawable.middleright, R.drawable.bottomleft, R.drawable.bottomcentre, R.drawable.bottomright};
    ...
    private static void resetBoard(){
        for(int i=0;i<squares.length;i++){
            ImageButton iBtn = (ImageButton) oxoFragment.mContentView.findViewById(squares[i]);
            iBtn.setImageResource(boardImages[i
                    ]);
        }
    }
